...
Proteinspy extracts key structural metadata from mmCIF files using

\[gemmi](https://gemmi.readthedocs.io/en/latest/) and displays results

beautifully in the terminal using \[rich](https://rich.readthedocs.io/).
...
| Resolution | Crystallographic resolution in Ångströms |
